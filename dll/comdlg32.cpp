...
BOOL WINAPI extGetOpenFileNameA(LPOPENFILENAMEA lpofn) {
    BOOL ret, FullScreen;
    FullScreen = dxw.IsFullScreen();
    OutTraceSYS("GetOpenFileNameA: FullScreen=%#x\n", FullScreen);
    dxw.SetFullScreen(FALSE);
    ret = (*pGetOpenFileNameA)(lpofn);
    dxw.SetFullScreen(FullScreen);
    OutTraceSYS("GetOpenFileNameA: ret=%#x\n", ret);
    return ret;
}
...
BOOL WINAPI extGetSaveFileNameW(LPOPENFILENAMEW lpofn) {
    BOOL ret, FullScreen;
    FullScreen = dxw.IsFullScreen();
    OutTraceSYS("GetSaveFileNameW: FullScreen=%#x\n", FullScreen);
    dxw.SetFullScreen(FALSE);
    ret = (*pGetSaveFileNameW)(lpofn);
    dxw.SetFullScreen(FullScreen);
    OutTraceSYS("GetSaveFileNameW: ret=%#x\n", ret);
    return ret;
}
...
BOOL WINAPI extGetOpenFileNameW(LPOPENFILENAMEW lpofn) {
    BOOL ret, FullScreen;
    FullScreen = dxw.IsFullScreen();
    OutTraceSYS("GetOpenFileNameW: FullScreen=%#x\n", FullScreen);
    dxw.SetFullScreen(FALSE);
    ret = (*pGetOpenFileNameW)(lpofn);
    dxw.SetFullScreen(FullScreen);
    OutTraceSYS("GetOpenFileNameW: ret=%#x\n", ret);
    return ret;
}
