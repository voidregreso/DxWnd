...
static int Getsegment(t_imdata *im, int arg, int defseg) {
    ...
    case PF_GS:
        ...
        return SEG_GS;
    default:
        return defseg;            // Most frequent case of default segment
    };
};
...
ulong Disasm(uchar const *cmd, ulong cmdsize, ulong ip, t_disasm *da,
    ...
    for (n = 0; ; n++) {
        ...
        case 0x65:
            ...
            break;
        case 0x66:
            prefix = prefixmask = PF_DSIZE;
            break;
        case 0x67:
            prefix = prefixmask = PF_ASIZE;
            break;
        case 0xF0:
            prefix = prefixmask = PF_LOCK;
            break;
        case 0xF2:
            prefix = PF_REPNE;
            prefixmask = PF_REPMASK;
            break;
        case 0xF3:
            prefix = PF_REP;
            prefixmask = PF_REPMASK;
        ...
        if (im.prefixlist & (PF_LOCK | PF_66 | PF_F2 | PF_F3))
            ...
            if (cmd[n] == 0xC5) {
                ...
                case 0x0100:
                    ...
                    break;
                case 0x0200:
                    vexlead = DX_VEX | DX_LEAD38;
                    n += 3;
                    break;
                case 0x0300:
                    vexlead = DX_VEX | DX_LEAD3A;
                    n += 3;
                    break;
                default:
                    vex = 0;
                    break;       // Unsupported VEX, decode as LES
                };
            };
            if (vex != 0) {
    ...
    case D_PUSH:
        if (datasize == 2) da->warnings |= DAW_STACK;
        break;
    case D_INT:
        da->warnings |= DAW_INTERRUPT;
        break;
    case D_IO:
        da->warnings |= DAW_IO;
        break;
