...
*/
static __inline void *scale2x_align_ptr(const void *ptr) {
    return (void *)ptr;
}
...
*/
static __inline unsigned scale2x_align_size(unsigned size) {
    return size;
}
...
*/
static __inline void stage_scale2x(void *dst0, void *dst1, const void *src0, const void *src1, const void *src2, unsigned pixel, unsigned pixel_per_row) {
    switch (pixel) {
    case 0x101 :
        scale2x_8_asm(SSDST(8, 0), SSDST(8, 1), SSSRC(8, 0), SSSRC(8, 1), SSSRC(8, 2), pixel_per_row);
        break;
    case 0x102 :
        scale2x_16_asm(SSDST(16, 0), SSDST(16, 1), SSSRC(16, 0), SSSRC(16, 1), SSSRC(16, 2), pixel_per_row);
        break;
    case 0x104 :
        scale2x_32_asm(SSDST(32, 0), SSDST(32, 1), SSSRC(32, 0), SSSRC(32, 1), SSSRC(32, 2), pixel_per_row);
        break;
    case 0x001 :
        scale2x_8_def(SSDST(8, 0), SSDST(8, 1), SSSRC(8, 0), SSSRC(8, 1), SSSRC(8, 2), pixel_per_row);
        break;
    case 0x002 :
        scale2x_16_def(SSDST(16, 0), SSDST(16, 1), SSSRC(16, 0), SSSRC(16, 1), SSSRC(16, 2), pixel_per_row);
        break;
    case 0x004 :
...
*/
static __inline void stage_scale2x3(void *dst0, void *dst1, void *dst2, const void *src0, const void *src1, const void *src2, unsigned pixel, unsigned pixel_per_row) {
    switch (pixel) {
    case 0x101 :
        scale2x3_8_asm(SSDST(8, 0), SSDST(8, 1), SSDST(8, 2), SSSRC(8, 0), SSSRC(8, 1), SSSRC(8, 2), pixel_per_row);
        break;
    case 0x102 :
        scale2x3_16_asm(SSDST(16, 0), SSDST(16, 1), SSDST(16, 2), SSSRC(16, 0), SSSRC(16, 1), SSSRC(16, 2), pixel_per_row);
        break;
    case 0x104 :
        scale2x3_32_asm(SSDST(32, 0), SSDST(32, 1), SSDST(32, 2), SSSRC(32, 0), SSSRC(32, 1), SSSRC(32, 2), pixel_per_row);
        break;
    case 0x001 :
        scale2x3_8_def(SSDST(8, 0), SSDST(8, 1), SSDST(8, 2), SSSRC(8, 0), SSSRC(8, 1), SSSRC(8, 2), pixel_per_row);
        break;
    case 0x002 :
        scale2x3_16_def(SSDST(16, 0), SSDST(16, 1), SSDST(16, 2), SSSRC(16, 0), SSSRC(16, 1), SSSRC(16, 2), pixel_per_row);
        break;
    case 0x004 :
        scale2x3_32_def(SSDST(32, 0), SSDST(32, 1), SSDST(32, 2), SSSRC(32, 0), SSSRC(32, 1), SSSRC(32, 2), pixel_per_row);
        break;
    }
}
...
*/
static __inline void stage_scale2x4(void *dst0, void *dst1, void *dst2, void *dst3, const void *src0, const void *src1, const void *src2, unsigned pixel, unsigned pixel_per_row) {
    switch (pixel) {
    case 0x101 :
        scale2x4_8_asm(SSDST(8, 0), SSDST(8, 1), SSDST(8, 2), SSDST(8, 3), SSSRC(8, 0), SSSRC(8, 1), SSSRC(8, 2), pixel_per_row);
        break;
    case 0x102 :
        scale2x4_16_asm(SSDST(16, 0), SSDST(16, 1), SSDST(16, 2), SSDST(16, 3), SSSRC(16, 0), SSSRC(16, 1), SSSRC(16, 2), pixel_per_row);
        break;
    case 0x104 :
        scale2x4_32_asm(SSDST(32, 0), SSDST(32, 1), SSDST(32, 2), SSDST(32, 3), SSSRC(32, 0), SSSRC(32, 1), SSSRC(32, 2), pixel_per_row);
        break;
    case 0x001 :
        scale2x4_8_def(SSDST(8, 0), SSDST(8, 1), SSDST(8, 2), SSDST(8, 3), SSSRC(8, 0), SSSRC(8, 1), SSSRC(8, 2), pixel_per_row);
        break;
    case 0x002 :
        scale2x4_16_def(SSDST(16, 0), SSDST(16, 1), SSDST(16, 2), SSDST(16, 3), SSSRC(16, 0), SSSRC(16, 1), SSSRC(16, 2), pixel_per_row);
        break;
    case 0x004 :
        scale2x4_32_def(SSDST(32, 0), SSDST(32, 1), SSDST(32, 2), SSDST(32, 3), SSSRC(32, 0), SSSRC(32, 1), SSSRC(32, 2), pixel_per_row);
        break;
    }
}
...
*/
static __inline void stage_scale3x(void *dst0, void *dst1, void *dst2, const void *src0, const void *src1, const void *src2, unsigned pixel, unsigned pixel_per_row) {
    switch (pixel) {
    case 0x101 :
        scale3x_8_def(SSDST(8, 0), SSDST(8, 1), SSDST(8, 2), SSSRC(8, 0), SSSRC(8, 1), SSSRC(8, 2), pixel_per_row);
        break;
    case 0x102 :
        scale3x_16_def(SSDST(16, 0), SSDST(16, 1), SSDST(16, 2), SSSRC(16, 0), SSSRC(16, 1), SSSRC(16, 2), pixel_per_row);
        break;
    case 0x104 :
        scale3x_32_def(SSDST(32, 0), SSDST(32, 1), SSDST(32, 2), SSSRC(32, 0), SSSRC(32, 1), SSSRC(32, 2), pixel_per_row);
        break;
    case 0x001 :
        scale3x_8_def(SSDST(8, 0), SSDST(8, 1), SSDST(8, 2), SSSRC(8, 0), SSSRC(8, 1), SSSRC(8, 2), pixel_per_row);
        break;
...
*/
static __inline void stage_scale4x(void *dst0, void *dst1, void *dst2, void *dst3, const void *src0, const void *src1, const void *src2, const void *src3, unsigned pixel, unsigned pixel_per_row) {
...
static void scale2x(void *void_dst, unsigned dst_slice, const void *void_src, unsigned src_slice, unsigned pixel, unsigned width, unsigned height) {
    ...
    for (count = 0; count < (int)height - 1; count++) {
        if(count == 0)
            ...
            stage_scale2x(SCDST(0 + 2 * count), SCDST(1 + 2 * count), SCSRC(0 + count), SCSRC(1 + count), SCSRC(1 + count), pixel, width);
        else
            stage_scale2x(SCDST(0 + 2 * count), SCDST(1 + 2 * count), SCSRC(0 + count), SCSRC(1 + count), SCSRC(2 + count), pixel, width);
    }
#else
    count = height;
    stage_scale2x(SCDST(0), SCDST(1), SCSRC(0), SCSRC(0), SCSRC(1), pixel, width);
...
static void scale3x(void *void_dst, unsigned dst_slice, const void *void_src, unsigned src_slice, unsigned pixel, unsigned width, unsigned height) {
    ...
    for (count = 0; count < (int)height - 2; count++) {
        if(count == 0)
            ...
            stage_scale3x(SCDST(0 + 3 * count), SCDST(1 + 3 * count), SCDST(2 + 3 * count), SCSRC(0 + count), SCSRC(1 + count), SCSRC(1 + count), pixel, width);
        else
            stage_scale3x(SCDST(0 + 3 * count), SCDST(1 + 3 * count), SCDST(2 + 3 * count), SCSRC(0 + count), SCSRC(1 + count), SCSRC(2 + count), pixel, width);
    }
#else
    count = height;
    stage_scale3x(SCDST(0), SCDST(1), SCDST(2), SCSRC(0), SCSRC(0), SCSRC(1), pixel, width);
...
static void scale4x_buf(void *void_dst, unsigned dst_slice, void *void_mid, unsigned mid_slice, const void *void_src, unsigned src_slice, unsigned pixel, unsigned width, unsigned height) {
    ...
    #pragma omp parallel for schedule(dynamic)
    for (count = 0; count < (int)height - 3; count++) {
        if(count == 0) {
            ...
            stage_scale2x(SCMID(0), SCMID(1), SCSRC(0), SCSRC(0), SCSRC(1), pixel, width);
            stage_scale2x(SCMID(2), SCMID(3), SCSRC(0), SCSRC(1), SCSRC(2), pixel, width);
            stage_scale2x(SCMID(4), SCMID(5), SCSRC(1), SCSRC(2), SCSRC(3), pixel, width);
            stage_scale4x(SCDST(0), SCDST(1), SCDST(2), SCDST(3), SCMID(-2 + 6), SCMID(-2 + 6), SCMID(-1 + 6), SCMID(0), pixel, width);
        } else if(count == (height - 4)) {
            stage_scale2x(SCMID(4), SCMID(5), SCSRC(2 + count), SCSRC(3 + count), SCSRC(3 + count), pixel, width);
            stage_scale4x(SCDST(0 + 4 * count), SCDST(1 + 4 * count), SCDST(2 + 4 * count), SCDST(3 + 4 * count), SCMID(1), SCMID(2), SCMID(3), SCMID(4), pixel, width);
            stage_scale4x(SCDST(4 + 4 * count), SCDST(5 + 4 * count), SCDST(6 + 4 * count), SCDST(7 + 4 * count), SCMID(3), SCMID(4), SCMID(5), SCMID(5), pixel, width);
        } else {
            switch (count % 3) {
            case 1:
                stage_scale2x(SCMID(4), SCMID(5), SCSRC(2 + count), SCSRC(3 + count), SCSRC(4 + count), pixel, width);
                stage_scale4x(SCDST(0 + 4 * count), SCDST(1 + 4 * count), SCDST(2 + 4 * count), SCDST(3 + 4 * count), SCMID(1), SCMID(2), SCMID(3), SCMID(4), pixel, width);
                break;
            case 2:
                stage_scale2x(SCMID(0), SCMID(1), SCSRC(2 + count), SCSRC(3 + count), SCSRC(4 + count), pixel, width);
                stage_scale4x(SCDST(0 + 4 * count), SCDST(1 + 4 * count), SCDST(2 + 4 * count), SCDST(3 + 4 * count), SCMID(3), SCMID(4), SCMID(5), SCMID(0), pixel, width);
                break;
            case 0:
                stage_scale2x(SCMID(2), SCMID(3), SCSRC(2 + count), SCSRC(3 + count), SCSRC(4 + count), pixel, width);
                stage_scale4x(SCDST(0 + 4 * count), SCDST(1 + 4 * count), SCDST(2 + 4 * count), SCDST(3 + 4 * count), SCMID(5), SCMID(0), SCMID(1), SCMID(2), pixel, width);
                break;
            }
        }
    }
...
static void blit_has_capability(unsigned int *has_asm) {
    unsigned regs[4];
    unsigned a, b;
    *has_asm = 0;
    blit_cpuid(0, regs);
...
void scale(unsigned scale, void *void_dst, unsigned dst_slice, const void *void_src, unsigned src_slice, unsigned pixel, unsigned width, unsigned height) {
    static unsigned int use_assembly = 0;
    static unsigned int do_once = 1;
    if(do_once) {
        blit_has_capability(&use_assembly);
        do_once = 0;
    }
    if(use_assembly) pixel |= 0x100;
    switch (scale) {
    case 202 :
    case 2 :
